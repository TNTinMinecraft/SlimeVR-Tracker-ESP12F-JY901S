...
//We use fixed address values instead of scanning to keep the sensorID consistent and to avoid issues with some breakout board with multiple active ic2 addresses
    ...
    #elif IMU == IMU_JY901
        #define PRIMARY_IMU_ADDRESS_ONE 0x50
        #define PRIMARY_IMU_ADDRESS_TWO 0x51
    #endif
    ...
    #elif SECOND_IMU == IMU_JY901
        #define SECONDARY_IMU_ADDRESS_ONE 0x50
        #define SECONDARY_IMU_ADDRESS_TWO 0x51
    #endif
